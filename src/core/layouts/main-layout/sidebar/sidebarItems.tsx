...
export const sellerSidebarItems: Readonly<Record<string, SidebarItem>> = {
  ...
  subscription: {
    name: "Subscription",
    href: SELLER_ROUTES.SUBSCRIPTION.CREDITS,
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm2.25 0a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm-18 0a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"
        />
      </svg>
    ),
  },
  ...
  export const distributorSidebarItems: Readonly<Record<string, SidebarItem>> = {
    ...
    orders: {
      ...
      children: ["all-orders", "pending-orders", "tracking", "returns", "invoices"],
    },
    "all-orders": {
      name: "All Orders",
    ...
    inventory: {
      ...
      children: ["current-stock", "replenishment", "expiry-tracking", "low-stock-alerts", "batch-wise"],
    },
    "current-stock": {
      name: "Current Stock",
    ...
    retailer: {
      ...
      children: ["retailer-directory", "onboarding", "retailer-orders", "credit-limits", "visit-logs"],
    },
    "retailer-directory": {
    ...
    logistics: {
      ...
      children: ["route-planning", "logistics-tracking", "dispatch-history", "delivery-personnel"],
    },
    "route-planning": {
    ...
    marketing: {
      ...
      children: ["promo-campaigns", "distributor-coupons", "schemes", "posm-requests"],
    },
    "promo-campaigns": {
    ...
    "brand-connect": {
      ...
      children: ["manufacturer-communications", "product-updates", "training-materials", "new-launches"],
    },
    ...
    crm: {
      ...
      children: ["lead-management", "retailer-issues", "ticketing-system", "feedback-collection"],
    },
    "lead-management": {
    ...
    analytics: {
      name: "Analytics",
      icon: <ChartBarIcon />,
      children: ["sales-analytics", "area-insights", "retailer-insights", "product-demand", "stock-movement", "margin-analytics"],
    },
    "sales-analytics": {
    ...
    finance: {
      ...
      children: ["payments", "credit-notes", "outstanding", "ledger", "commission"],
    },
    payments: {
      name: "Payments",
  ...
  export const manufacturerSidebarItems: Readonly<Record<string, SidebarItem>> = {
    ...
    products: {
      ...
      children: ["all-products", "formulations", "ingredients-library", "bom", "packaging-specs", "variants", "regulatory"],
    },
    "all-products": {
      name: "All Products",
    ...
    production: {
      ...
      children: ["create-batch", "batch-tracking", "quality-reports", "scheduling", "batch-allocation", "capacity-planner", "equipment-utilization"],
    },
    "create-batch": {
      name: "Create Batch",
    ...
    inventory: {
      ...
      children: ["raw-material-inventory", "packaging-inventory", "finished-goods", "low-stock-alerts", "expiry-management", "supplier-sync"],
    },
    ...
    orders: {
      ...
      children: ["purchase-orders", "distributor-orders", "fulfillment", "packing-slips", "invoices", "shipping"],
    },
    "purchase-orders": {
    ...
    suppliers: {
      ...
      children: ["approved-suppliers", "raw-material-suppliers", "packaging-suppliers", "supplier-onboarding", "supplier-ratings", "supplier-compliance"],
    },
    "approved-suppliers": {
    ...
    compliance: {
      ...
      children: ["qa-reports", "stability-studies", "safety-sheets", "audit-logs", "checklists", "recall-management"],
    },
    "qa-reports": {
      name: "QA/QC Reports",
    ...
    "brand-collaboration": {
      ...
      children: ["oem-requests", "brand-briefs", "formulation-requests", "sampling-requests", "contracts"],
    },
    "oem-requests": {
    ...
    marketing: {
      ...
      children: ["media-files", "marketing-kits", "content-library", "claims-approval"],
    },
    "media-files": {
    ...
    analytics: {
      name: "Analytics",
      icon: <ChartBarIcon />,
      children: ["production-analytics", "raw-material-forecast", "cogs", "equipment-efficiency", "demand-forecast", "sku-performance"],
    },
    ...
    finance: {
      ...
      children: ["payouts", "expense-tracking", "cost-sheets", "pricing-management"],
    },
    payouts: {
      name: "Payouts",
    ...
    settings: {
      ...
      children: ["user-roles", "factory-profile", "api-integrations", "notification-settings"],
    },
    "user-roles": {
      name: "User Roles & Permissions",
