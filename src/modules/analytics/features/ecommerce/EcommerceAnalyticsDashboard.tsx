...
const EcommerceAnalyticsDashboard: React.FC<EcommerceAnalyticsDashboardProps> = ({
  isAdmin = false
}) => {
  ...
  const impressionsChange = { value: "+4.6% from last month", isPositive: true };
  ...
  useEffect(() => {
    const days = timePeriod === "daily" ? 7 : timePeriod === "weekly" ? 4 : timePeriod === "monthly" ? 12 : 12;
