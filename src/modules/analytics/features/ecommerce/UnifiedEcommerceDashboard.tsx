                ...
                <div className="flex items-center gap-4">
                  <div className="flex-1">
                    <div className="mb-1 text-2xl font-bold text-gray-900">
                      {salesTarget.current >= 1000
                        ? `${(salesTarget.current / 1000).toFixed(1)}K`
                        : salesTarget.current}{" "}
                      /{" "}
                      {salesTarget.target >= 1000
                        ? `${(salesTarget.target / 1000).toFixed(1)}K`
                        : salesTarget.target}{" "}
                      Units
                    </div>
                    <p className="text-sm text-gray-500">
                      Made this {timePeriod}
                    </p>
                  </div>
                      ...
                      >
                        ...
                        <circle
                          ...
                          strokeDashoffset={
                            201.06 -
                            (Math.round(
                              (salesTarget.current / salesTarget.target) * 100,
                            ) /
                              100) *
                              201.06
                          }
