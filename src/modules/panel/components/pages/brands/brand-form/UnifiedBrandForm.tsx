...
// import type { BrandApiResponse, UnifiedBrandFormProps } from "./types";
...
// const BrandForm: React.FC<UnifiedBrandFormProps> = ({
//   mode,
//   title,
//   description,
...
//       // Transform BrandFormData to Brand format
//       const ids = extractBrandIds(data);
//       const convertedData = transformBrandFormDataToBrand(data);
...
//   const onError = useCallback((errors: FieldErrors<BrandFormData>) => {
...
//               <div className="space-y-6 rounded-xl border bg-white p-8 shadow-sm">
//                 <SocialMediaSection control={control} mode={mode} />

//                 <SellingPlatformsSection control={control} mode={mode} />

//                 <AuthorizationLetterSection control={control} mode={mode} />
//               </div>
//             </div>
