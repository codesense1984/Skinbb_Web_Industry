...
export const BrandPageWrapper = ({
  ...
  const handleSubmit = (data: UnifiedBrandFormData) => {
    ...
    const convertedData: CompanyLocationBrandFormData = {
      name: (dataRecord.brand_name as string) || (dataRecord.name as string) || "",
      aboutTheBrand: (dataRecord.description as string) || "",
      websiteUrl: (dataRecord.website_url as string) || (dataRecord.websiteUrl as string) || "",
      ...
      sellingOn: Array.isArray(dataRecord.sellingOn) 
        ...
        : [],
      authorizationLetter: (dataRecord.brand_authorization_letter as string) || "",
      ...
      authorizationLetter_files: Array.isArray(dataRecord.brand_authorization_letter_files)
