    ...
    return (
      ...
      >
        <div className="flex flex-col items-center justify-center py-8">
          <p className="mb-4 text-red-500">Failed to load product details</p>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <p id="product-name" className="text-sm">
                    {product.productName}
                  </p>
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                <label
                  htmlFor="product-brand-info"
                  className="text-sm font-medium text-gray-700"
                >
                  About the Brand
                </label>
                <p id="product-brand-info" className="text-sm">
                  {product.aboutTheBrand || "No brand information provided"}
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                <div className="space-y-2">
                  ...
                  <p id="product-price" className="text-sm font-semibold">
                ...
                <div className="space-y-2">
                  ...
                  <p id="product-quantity" className="text-sm">
                    {product.quantity}
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <p id="product-brand" className="text-sm">
                    {product.brand || "N/A"}
                  </p>
                </div>
                <div className="space-y-2">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="space-y-2">
                  <label
                    htmlFor="product-marketed-by"
                    className="text-sm font-medium text-gray-700"
                  >
                    Marketed By
                  </label>
                  <p id="product-marketed-by" className="text-sm">
                    {product.marketedBy?.name || "N/A"}
                  </p>
                ...
                <div className="space-y-2">
                  <label
                    htmlFor="product-manufactured-by"
                    className="text-sm font-medium text-gray-700"
                  >
                    Manufactured By
                  </label>
                  <p id="product-manufactured-by" className="text-sm">
                    {product.manufacturedBy?.name || "N/A"}
                  </p>
                ...
                <div className="space-y-2">
                  <label
                    htmlFor="product-imported-by"
                    className="text-sm font-medium text-gray-700"
                  >
                    Imported By
                  </label>
                  <p id="product-imported-by" className="text-sm">
                    {product.importedBy?.name || "N/A"}
                  </p>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="space-y-2">
                  ...
                  <p id="country-of-origin" className="text-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p id="product-form" className="text-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p id="target-area" className="text-sm">
                    {product.targetArea || "N/A"}
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p id="fragrance" className="text-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="space-y-2">
                  ...
                  <p id="dimensions" className="text-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p id="shelf-life" className="text-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p id="license-number" className="text-sm">
                    {product.licenseNo || "N/A"}
                  </p>
                </div>
                <div className="space-y-2">
                  <label
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="rounded"
                  />
                  <label htmlFor="is-new-arrival" className="text-sm">
                    New Arrival
                  </label>
                </div>
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="rounded"
                  />
                  <label htmlFor="is-best-seller" className="text-sm">
                    Best Seller
                  </label>
                </div>
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="rounded"
                  />
                  <label htmlFor="is-trending-now" className="text-sm">
                    Trending Now
                  </label>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p id="meta-title" className="text-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p id="meta-description" className="text-sm">
                  ...
                  <div className="space-y-2">
                    ...
                    <div id="product-images" className="flex flex-wrap gap-2">
                      {product.images.map((image, index) => (
                        <AvatarRoot key={index} className="h-16 w-16">
                          <AvatarImage
                            src={image}
