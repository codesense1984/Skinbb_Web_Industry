...
const OnboardLayout = () => {
  ...
  `}
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-12">
        <div
          className="order-2 lg:order-1 from-secondary to-secondary relative flex h-[100dvh] items-center justify-center bg-linear-to-b p-4 py-10 md:top-0 md:px-8 md:py-12 lg:sticky lg:col-span-5"
        ...
        <div className="order-1 lg:order-2 col-span-7 w-full">
