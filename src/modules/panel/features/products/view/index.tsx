          ...
          <div className="mt-6 bg-white shadow-sm rounded-lg p-6">
            ...
            <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-3">
              ...
              <div>
                ...
                <dd className="mt-1 text-sm text-gray-900">${product.salePrice}</dd>
              </div>
              <div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white shadow-sm rounded-lg p-6">
            ...
            <div className="space-y-3">
              <Link
                to={PANEL_ROUTES.PRODUCT.EDIT(product.id)}
                className="block w-full text-center px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                Edit Product
              </Link>
              <button
                type="button"
                className="block w-full text-center px-4 py-2 text-sm font-medium text-red-700 bg-red-50 border border-red-200 rounded-md hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-red-500"
              >
                Delete Product
              </button>
            </div>
