...
import type { RoleListResponse, RoleListParams } from "@/modules/panel/types/role.type";
...
export async function apiGetRoles(
  ...
  try {
    ...
    const url = queryString ? `${ENDPOINTS.ROLE.LIST}?${queryString}` : ENDPOINTS.ROLE.LIST;
