  ...
  },
  {
    ...
    cell: ({ row }: { row: { original: Promotion } }) => {
      ...
      return (
        <TableAction
          view={{
            to: SELLER_ROUTES.MARKETING.PROMOTIONS.VIEW(promotion._id),
            title: "View promotion details",
          }}
          edit={{
            to: SELLER_ROUTES.MARKETING.PROMOTIONS.EDIT(promotion._id),
...
const PromotionsList = () => {
  ...
  const renderCard = useMemo(
    () => (promotion: Promotion) => (
      <NavLink to={SELLER_ROUTES.MARKETING.PROMOTIONS.VIEW(promotion._id)}>
    ...
    >
      <div className="w-full">
        <DataView<Promotion>
          ...
          defaultPageSize={10}
          enableUrlSync={false}
          queryKeyPrefix={SELLER_ROUTES.MARKETING.PROMOTIONS.LIST}
